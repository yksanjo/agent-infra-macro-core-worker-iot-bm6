# agent-infra-macro-core-worker-iot-bm6

## Detailed Description

agent-infra-macro-core-worker-iot-bm6 is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
